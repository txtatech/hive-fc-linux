...
An experimental V86 (browser) Linux (or FreeDOS) to be stored on the blockchain that uses the hive-file-chunker method to
...
# CONSIDERATIONS
FreeDOS is 19 JSON chunk files.

Linux is 57 JSON chunk files.

The 19 JSON files represent 19 chunks that would correspond to 19 blocks of data on the Hive blockchain which is a manageable number
